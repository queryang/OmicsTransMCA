...
def main(
    ...
    model_name = params.get("model_fn", "conv_trans_mca_GEP")
...
if __name__ == "__main__":
    ...
    omics_filepath = 'data/Omics_GEP_CNV_MUT_MEDICUS.csv'
    ...
    training_name = 'CONV_TRANS_MCA_GEP_MEDICUS619_Clipping'
    # run the training
    main(
        train_sensitivity_filepath,
        test_sensitivity_filepath,
