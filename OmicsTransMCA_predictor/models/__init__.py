...
from OmicsTransMCA_predictor.models.TransMCA_Dense_GEP_CNV_MUT_V2 import Conv_TransMCA_GEP_CNV_MUT_V2
...
MODEL_FACTORY = {
    ...
    'trans_mca_dense_GEP_CNV_MUT_V2': Conv_TransMCA_GEP_CNV_MUT_V2,
