...
class TransMCA_NonDense_GEP_MUT(nn.Module):
    ...
    """
        ...
        super(TransMCA_NonDense_GEP_MUT, self).__init__(*args, **kwargs)
        ...
        self.hidden_sizes = (
            [
                ...
                sum(self.mut_heads) * self.mut_features +
                # 多尺度卷积
                sum(
                    [
                        h * f
    ...
    def forward(self, smiles, gep, mut):
