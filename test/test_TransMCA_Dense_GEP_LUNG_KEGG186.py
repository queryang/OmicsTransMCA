...
def main(
    ...
    gene_attentions.to_csv('attention_result/GEP_CellBlind_LUNG_KEGG186_gene_attention.csv',index=False)
    smiles_attentions_geps.to_csv('attention_result/GEP_CellBlind_LUNG_KEGG186_smiles_attentions_gep.csv',index=False)
