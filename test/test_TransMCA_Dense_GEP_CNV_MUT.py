    ...
    params.update(
        {
            ...
            "drug_sensitivity_processing_parameters": test_dataset.drug_sensitivity_processing_parameters,
...
if __name__ == "__main__":
    ...
    test_sensitivity_filepath = '../model_omics_experiment/data/drug_sensitivity_MixedSet_test.csv'
    ...
    model_path = 'models/TRANS_MCA_GEP_CNV_MUT_MEDICUS619_1536_Clipping/weights/best_mse_trans_mca_dense_GEP_CNV_MUT.pt'
    params_filepath = '../model_omics_experiment/data/params/TransMCA_Dense_GEP_CNV_MUT.json'
