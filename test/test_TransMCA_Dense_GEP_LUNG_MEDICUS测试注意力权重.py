...
if __name__ == "__main__":
    ...
    model_path = 'models/TRANS_MCA_GEP_V2_Lung_CellBlind_AttLayerReBuild/weights/best_mse_trans_mca_dense_GEP_V2.pt'
    params_filepath = 'models/TRANS_MCA_GEP_V2_Lung_CellBlind_AttLayerReBuild/model_params.json'
