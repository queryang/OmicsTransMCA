...
def main(
    ...
    model_name = params.get("model_fn", "mca_GEP_CNV_MUT")
...
if __name__ == "__main__":
    ...
    params_filepath = 'data/params/MCA_GEP_CNV_MUT.json'
    training_name = 'MCA_GEP(Log10_P_value)_CNV(Cardinality_Analysis)_MUT_MEDICUS619'
    # run the training
    main(
        train_sensitivity_filepath,
        test_sensitivity_filepath,
