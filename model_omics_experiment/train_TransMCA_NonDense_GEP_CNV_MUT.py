...
def main(
    ...
    model_name = params.get("model_fn", "trans_mca_nondense_GEP_CNV_MUT")
...
if __name__ == "__main__":
    ...
    params_filepath = 'data/params/TransMCA_NonDense_GEP_CNV_MUT.json'
    training_name = 'TRANS_MCA_Non_Dense_GEP_CNV(Cardinality_Analysis)_MUT_MEDICUS619_clipping'
    # run the training
    main(
        train_sensitivity_filepath,
        test_sensitivity_filepath,
