...
if __name__ == "__main__":
    ...
    train_sensitivity_filepath = 'data/drug_sensitivity_lung_CellBlind_train.csv'
    test_sensitivity_filepath = 'data/drug_sensitivity_lung_CellBlind_test.csv'
    ...
    params_filepath = 'data/params/TransMCA_Dense_V2_GEP.json'
    training_name = 'TRANS_MCA_GEP_V2_Lung_CellBlind_AttLayerReBuild'
    # run the training
    main(
        train_sensitivity_filepath,
        test_sensitivity_filepath,
