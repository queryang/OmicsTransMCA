...
def main(
    ...
    model_name = params.get("model_fn", "mca_dense_GEP_MUT")
...
if __name__ == "__main__":
    ...
    params_filepath = 'data/params/MCA_Dense_GEP_MUT.json'
    training_name = 'MCA_Dense_GEP_CNV(Cardinality_Analysis)_MUT_MEDICUS619'
    # run the training
    main(
        train_sensitivity_filepath,
        test_sensitivity_filepath,
